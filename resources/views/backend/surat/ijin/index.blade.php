		...
		<div class="row">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a href="{{ route('backend.surat.ijin_detail',$item->kd) }}" target="_blank">
											<span class="badge badge-success">Detail</span>
										</a>
										<a href="{{ route('backend.surat.ijin_delete',$item->id) }}" onclick="return confirm('Anda yakin ingin menghapus ?')">
			...
			<div class="col-xl-5">
				<div class="card">
					...
					<div class="card-body">
						{!! Form::open(['route'=>'backend.surat.ijin_store','method'=>'POST','files' => true]) !!}
						@include('backend.surat.ijin.form')
