    ...
    <table cellspacing="0" id="table-basic" class="tablex table-sm table-bordered table-striped table-hover" style="min-width: 1200px;">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-right">{{ rupiahnon2($item->tunjangan_makan) }}</td>
					<td class="text-right">{{ rupiahnon2($item->tunjangan_transport) }}</td>
					<td class="text-right">{{ rupiahnon2($item->tunjangan_sewa) }}</td>
					...
					<td class="text-right">{{ isset($item->lembur) ? rupiahnon2($item->lembur) : 0 }}</td>
					<td class="text-right">{{ isset($item->thr) ? rupiahnon2($item->thr) : 0 }}</td>
					<td class="text-right">{{ rupiahnon2($item->trf15) }}</td>
					<td class="table-info text-right">{{ rupiahnon($item->full_pendapatan) }}</td>
					...
					<td class="table-info text-right">{{ rupiahnon2($item->full_potongan) }}</td>
					<td class="table-success text-right">{{ rupiahnon2($item->total_trf) }}</td>
