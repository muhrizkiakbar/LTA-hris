							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a href="{{ route('backend.cuti.tahunan.detail',$item->kd) }}" class="badge badge-info" target="_blank">Detail</a>
										@if (auth()->user()->role_id <= 4)
											<a href="{{ route('backend.cuti.tahunan.delete',$item->id) }}" onclick="return confirm('Anda yakin ingin menghapus ?')" class="badge badge-danger">Delete</a>
										@endif
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var oTable = $('.datatable-basic').DataTable({
      ...
      var url = '{{ route('backend.cuti.tahunan.create') }}';
