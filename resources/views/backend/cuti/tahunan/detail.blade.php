		...
		<div class="row">
			<div class="col-xl-12">
              ...
              <div class="text-center mb-2">
                <h4 class="text-uppercase" style="font-weight: 800"><u>Pengajuan Cuti Tahunan</u></h4>
                ...
                <tr>
                  <td colspan="3" class="text-center"><strong>DETAIL CUTI</strong></td>
                </tr>
                <tr>
                  <td class="text-center">1</td>
                  <td>Tanggal Cuti</td>
                ...
                <tr>
                  ...
                  <td>{{ $get->cuti_qty - $lines_count }} Hari</td>
                </tr>
                <tr>
                  <td class="text-center">6</td>
                  <td>Pengganti Sementara</td>
                  <td>{{ isset($get->employee_exchange) ? $get->employee_exchange->name : '-' }}</td>
                </tr>
              </table>
...
<script type="text/javascript">
	$(document).ready(function(){
      ...
      var id = $(this).data('id');
      var url = '{{ route('backend.cuti.tahunan.periksa') }}';
      ...
      var id = $(this).data('id');
      var url = '{{ route('backend.cuti.tahunan.setuju') }}';
			var token = '{{ csrf_token() }}';
			$('#overlay').fadeIn();
      $.ajax({
        url: url,
      ...
      var id = $(this).data('id');
      var url = '{{ route('backend.cuti.tahunan.ketahui') }}';
			var token = '{{ csrf_token() }}';
			$('#overlay').fadeIn();
      $.ajax({
        url: url,
      ...
      var id = $(this).data('id');
      var url = '{{ route('backend.cuti.tahunan.reject') }}';
			var token = '{{ csrf_token() }}';
			Swal.fire({
