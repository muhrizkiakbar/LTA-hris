		...
		<div class="row">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<a href="{{ route('backend.master.lokasi.delete',$item->id) }}" onclick="return confirm('Anda yakin ingin menghapus ?')">
			...
			<div class="col-xl-6">
				<div class="card">
					...
					<div class="card-body">
						{!! Form::open(['route'=>'backend.master.lokasi.store','method'=>'POST','files'=>true]) !!}
    ...
    var oTable = $('.datatable-basic').DataTable({
        ...
        $(this).find('tbody tr').slice(-3).find('.dropdown, .btn-group').addClass('dropup');
				...
				$(".edit").click(function(e) {
					var id = $(this).data('id');
					var url = '{{ route('backend.master.lokasi.edit') }}';
