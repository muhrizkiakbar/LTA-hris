...
use App\Services\Cuti\BersamaServices;
use Illuminate\Http\Request;

class BersamaController extends Controller
{
	public function __construct(BersamaServices $service)
	{
	...
	public function index()
	{
      ...
      'title' => 'Cuti Bersama',
			'section' => 'cuti',
			'sub_section' => 'cuti_bersama',  
      'assets' => $assets,
			'row' => $row
    ];

		return view('backend.cuti.bersama.index')->with($data);
	}
